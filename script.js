...
const languageText = {
  "祝贺李蕊玉团队获第十七届过程装备实践与创新赛全国总决赛一等奖": "Congratulations to Li Ruiyu’s Team on Winning First Prize at the National Finals of the 17th Process Equipment Practice and Innovation Competition",
  "祝贺孙思博团队获第四届全国大学生“力学+”创新实践研讨会三等奖": "Congratulations to Sun Sibo’s Team on Winning Third Prize at the 4th National University Students’ “Mechanics+” Innovation and Practice Symposium",
  "2026年8月，本科生李蕊玉等同学凭借作品“微纳智测——微纳米材料力学实验测试装置”，在2026年中国大学生机械工程创新创意大赛第十七届过程装备实践与创新赛全国总决赛中获一等奖。指导教师为王晓媛、闫亚宾。": "In August 2026, Li Ruiyu and fellow undergraduate students won first prize at the national finals of the 17th Process Equipment Practice and Innovation Competition, part of the 2026 Chinese University Students’ Mechanical Engineering Innovation and Creativity Competition. Their project, “Micro/Nano Intelligent Testing — A Mechanical Testing Device for Micro- and Nanoscale Materials,” was supervised by Xiaoyuan Wang and Yabin Yan.",
  "作品面向微纳米材料的力学测试需求，将精密机械设计、实验测试与智能控制相结合，探索小型化、集成化测试装置的设计与实现，为观察材料微观变形、研究力学行为提供实验工具。": "The project addresses mechanical testing of micro- and nanoscale materials by combining precision mechanical design, experimental testing, and intelligent control. It explores the design and implementation of a compact, integrated testing device for observing microscopic deformation and investigating mechanical behavior.",
  "此次获奖是同学们将课堂知识应用于工程实践的一次重要收获。祝贺获奖同学与指导教师，期待团队继续在实验装置研发与工程创新中取得进步！": "This award marks an important achievement in applying classroom knowledge to engineering practice. Congratulations to the students and their supervisors as they continue developing experimental instruments and pursuing engineering innovation.",
  "2026年8月，本科生孙思博等同学凭借“微纳智测”项目，在第四届全国大学生“力学+”创新实践研讨会中获三等奖。项目聚焦微纳米材料力学原位实验测试装置，由闫亚宾、王晓媛老师指导。": "In August 2026, Sun Sibo and fellow undergraduate students won third prize at the 4th National University Students’ “Mechanics+” Innovation and Practice Symposium with their “Micro/Nano Intelligent Testing” project. Supervised by Yabin Yan and Xiaoyuan Wang, the project focuses on an in-situ mechanical testing device for micro- and nanoscale materials.",
  "项目围绕微纳力学测试的“原位化、多模态、智能化”需求，结合扫描电子显微镜观测与精密加载，让材料变形与失效过程能够与力学响应同步研究。": "Addressing the need for in-situ, multimodal, and intelligent micromechanical testing, the project combines scanning electron microscopy with precision loading to study material deformation and failure alongside the mechanical response.",
  "技术方案包括“智寻、智动、智感”三个模块：通过自动对中与聚焦辅助试样定位和观测；结合宏观快速定位、压电驱动与柔性传动实现精密加载；集成压痕、划痕、拉压、剪切等测试模式，并探索力热耦合与多通道同步数据采集。": "The technical approach comprises three modules for intelligent positioning, actuation, and sensing. Automatic alignment and focusing assist specimen positioning and observation; coarse positioning, piezoelectric actuation, and compliant transmission enable precision loading; multiple testing modes include indentation, scratching, tension, compression, and shear, with exploration of thermomechanical coupling and synchronized multichannel data acquisition.",
  "从装置设计到实物展示，同学们将力学知识、机构设计与实验方法融入创新实践，展现了面向科研需求开展工程探索的能力。祝贺团队取得佳绩！": "From instrument design to prototype demonstrations, the students brought together mechanics, mechanism design, and experimental methods to address research needs through engineering practice. Congratulations to the team on this achievement!",
  "第十七届过程装备实践与创新赛全国总决赛参赛师生合影": "Students and faculty at the national finals of the 17th Process Equipment Practice and Innovation Competition",
  "孙思博等同学与指导教师在项目海报前合影": "Sun Sibo and fellow students with their supervisors beside the project poster",
  "团队讨论微纳米材料力学实验测试装置": "The team discussing the mechanical testing device for micro- and nanoscale materials",
  ...
  "机械与动力工程学院": "School of Mechanical and Power Engineering",
  "副研究员": "Associate Researcher",
  "特任研究员 / 访问学者": "Specially Appointed Researcher / Visiting Scholar",
  "工学博士": "Ph.D. in Engineering",
  "日本京都大学": "Kyoto University, Japan",
  "机械工程与科学系": "Department of Mechanical Engineering and Science",
  "展开": "Expand",
  "收起": "Collapse",
  "在读": "Current",
  "毕业啦": "Alumni",
